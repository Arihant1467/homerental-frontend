...
class Search extends Component {
    ...
    componentDidUpdate(prevProps,prevState){
        ...
        console.log("Are search criteria different"+areSearchCriteriaDifferent);
        ...
        /*
        if(areSearchCriteriaDifferent || areStepperDifferent){
            const newSearchCriteria = Object.assign({},searchCriteria,{stepper:currentStepper,
                maxPriceFilter,minBedroomFilter
            });
    ...
    componentDidMount(){
        ...
        const data = this.props.searchCriteria;
        axios.post("http://localhost:3501/search",data).then(response =>{
    ...
    render() { 
        ...
        /*
        results = results.filter((property,index)=>{
            
            if(maxPriceFilter == null){
                console.log("minbedroom filter");
                return (property.bedroom>=minBedroomFilter); 
            }
            else{
                return (property.baserate<=maxPriceFilter && property.bedroom>=minBedroomFilter);
            }
        });
        */
        ...
        if(this.state.propertySelected){
            ...
            //const redirecturl = "/overview/"+this.state.selectedPropertyId+"?startdate=2018-10-15&enddate=2018-10-15";
